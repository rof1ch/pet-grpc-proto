...
func (x *RegisterRouter) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
func (x *RegisterRouter) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x42, 0x0a, 0x0e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	0x72, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c,
	...
	0x73, 0x74, 0x65, 0x72, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x72, 0x1a, 0x16, 0x2e, 0x61, 0x75, 0x74,
	...
	0x72, 0x6f, 0x66, 0x31, 0x63, 0x68, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73,
...
var file_sso_sso_proto_goTypes = []any{
	(*RegisterRouter)(nil),   // 0: auth.RegisterRouter
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Register:input_type -> auth.RegisterRouter
