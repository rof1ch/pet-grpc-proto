...
type AuthClient interface {
	Register(ctx context.Context, in *RegisterRouter, opts ...grpc.CallOption) (*RegisterResponse, error)
...
func (c *authClient) Register(ctx context.Context, in *RegisterRouter, opts ...grpc.CallOption) (*RegisterResponse, error) {
...
type AuthServer interface {
	Register(context.Context, *RegisterRouter) (*RegisterResponse, error)
...
func (UnimplementedAuthServer) Register(context.Context, *RegisterRouter) (*RegisterResponse, error) {
...
func _Auth_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Register(ctx, req.(*RegisterRouter))
	}
